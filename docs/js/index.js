...
const questions = [
  "¿Qué es lo que te motiva y te da energía para enfrentar el día a día? ¿Por qué?",
  "¿Qué es lo que más te está preocupando en este momento?",
  "¿Qué actividades o personas te han ayudado a sentir mejor en los últimos días y por qué crees que te han ayudado?",
  "Si te sientes cómodo hablando de ello, ¿podrías describirme la situación que te está molestando en este momento?",
  "¿Has hablado con alguien más sobre cómo te sientes?",
  "¿Qué actividades disfrutas haciendo en tu tiempo libre y por qué las disfrutas?",
  "¿Tienes algún sueño o meta que te gustaría alcanzar en el futuro? ¿Cuál y por qué?",
  ...
  "¿Tienes algun trauma?",
  "¿Cuál es tu forma favorita de relajarte o desconectar de la rutina diaria?",
  "¿Como es tu relacion con tu familia?",
  "¿Hay algo que te preocupe o te genere ansiedad últimamente?",
  ...
  "¿Que te hace enojar realmente?¿Por qué?",
  "¿Hay algún cumplido que te hayan dado que te haya hecho sentir especialmente bien?",
  "¿Cuál es la cosa que más te frustra en tu día a día? ¿Por qué?",
  "¿Cual es el logro del que mas te enorgulleces? ¿Por qué?",
  "¿Como te hace sentir tu libro favorito? ¿Por qué?",
  "¿Hay alguna actividad o situación que te haga sentir especialmente vivo/a?",
  "¿Como te hizo sentir la ultima pelicula que viste y por qué?",
  "¿Que querias ser cuando fueras grande y por qué?",
  "¿Hay alguna cosa por la que te sientas especialmente agradecido/a en este momento?",
];
